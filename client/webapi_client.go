...
// NewHTTPClient creates a new webapi HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Webapi {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new webapi HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Webapi {
...
// New creates a new webapi client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Webapi {
	// ensure nullable parameters have default
	if formats == nil {
